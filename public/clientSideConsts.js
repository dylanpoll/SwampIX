// this is for local variables that the client side pages may use, made it so it would be easy to work with.
export const getServiceEndpoint = 'https://appwrite.devdylan.us/v1';
